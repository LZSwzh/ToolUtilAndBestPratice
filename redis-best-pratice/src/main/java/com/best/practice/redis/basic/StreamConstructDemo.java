...
//                .withId();id可以自动生成，也可以自定义
        ...
        //是否自动生成
        boolean isAuto = recordId.shouldBeAutoGenerated();
        //id的取值
    ...
    public void add(String key, Map<String,String> record){
        ...
        //方式2直接传入Record对象
        StringRecord record2 = StreamRecords.string(Collections.singletonMap("name", "value"))
                .withStreamKey("streamKey");
        RecordId recordId2 = redisTemplate.opsForStream().add(record2);
