package com.best.practice.redis.constructmq.bystream.config;

import com.best.practice.redis.constructmq.bystream.StreamTaskConsumerListener;
...
public class StreamConfig {
    ...
    public StreamMessageListenerContainer<String, ObjectRecord<String, String>> streamMessageListenerContainer(
            RedisConnectionFactory connectionFactory, StreamTaskConsumerListener messageConsumer) {
        ...
        listenerContainer.receive(
                ...
                StreamOffset.create(streamKey, ReadOffset.lastConsumed()), messageConsumer);
