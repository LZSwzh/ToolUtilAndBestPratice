...
public class RequireTest extends PropagationParentTest{

    @Resource
    private OrderService orderService;

    @Test
    public void testChildTransactionWithRequires() {
        ...
        orderVO.setOrderNum("TEST-PROPAGATION-002");
