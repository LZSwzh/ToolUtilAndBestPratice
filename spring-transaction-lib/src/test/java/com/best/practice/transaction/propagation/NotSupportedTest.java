...
public class NotSupportedTest extends PropagationParentTest{
    @Resource
    private OrderService orderService;

    @Test
    public void testChildTransactionWithNotSupported(){
        OrderItemVO orderItemVO = new OrderItemVO();
        orderItemVO.setOrderItemId(null);
        orderItemVO.setOrderId(null);
        orderItemVO.setProductId(2);
        orderItemVO.setSkuId(1);
        orderItemVO.setSkuName("SKU-4");
        ...
        orderItemVO2.setSkuName("SKU-4-1");
        ...
        orderVO.setOrderNum("TEST-PROPAGATION-004");
        ...
        orderService.createOrderWithNotSupported(orderVO);
    }
}
